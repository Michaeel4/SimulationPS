package desmoj.demo.histo_time;
...
public class Schalter1_e_model extends Model {
    ...
    public TimeSeries warteschlangeZeitreihe;

    // Histogram für Wartezeiten
    ...
    * Initialisierung der benutzten DESMO-J Infrastruktur
    ...
    public void init() {
        ...
        waitTimeHistogram = new Histogram(this, "Wartezeiten-Histogramm", 0, 100, 10, true, true);
        TimeInstant startTime = new TimeInstant(0);
        TimeInstant endTime = new TimeInstant(240);
        warteschlangeZeitreihe = new TimeSeries(this, "Warteschlange Zeitreihe", startTime, endTime, true, true);
...
//        Histogram[] hist;
        ...
        schalterExperiment.stop(new TimeInstant(480));
...
//        for (SchalterEntity schalterEntity : sch_e_model.besetzteSchalterQueue) {
//
//            var i = 1;
//
//            System.out.println(schalterEntity.getName());
//            hist[i] = new Histogram(sch_e_model.getModel(), "residence time for route " + i, new double[] { 0, 25, 50, 75, 100, 150, 200, 300, 400} ,false, true);
//            i++;
//        }

//        for (int i = 0; i < sch_e_model.getBedienZeit(); i++) {
//            hist[i] = new Histogram(sch_e_model, "residence time for route " + i, new double[] { 0, 25, 50, 75, 100, 150, 200, 300, 400} ,true, false);
//        } //
//
